    ...
    <div class="relative" ref="dropdownRef">
        ...
        >
            ...
            <ul class="flex flex-col h-auto overflow-y-auto custom-scrollbar">
                ...
                >
                    <button
                        class="flex w-full gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5 text-left"
...
import { Link, router } from "@inertiajs/vue3"; // ✅ Ganti dengan Link dari Inertia

const dropdownOpen = ref(false);
const notifying = ref(true);
const dropdownRef = ref(null);

// Data notifikasi untuk Nagira Farm
const notifications = ref([
    {
        id: 1,
        userName: "Budi Santoso",
        userImage: "/images/user/user-02.jpg",
        action: "melaporkan masalah kesehatan pada",
        project: "Sapi #A-001",
        type: "Kesehatan",
        time: "5 menit lalu",
        status: "online",
        route: "/admin/health/1",
    },
    {
        id: 2,
        userName: "Siti Rahayu",
        userImage: "/images/user/user-03.jpg",
        action: "melakukan inseminasi pada",
        project: "Sapi #B-045",
        type: "Breeding",
        time: "15 menit lalu",
        status: "offline",
        route: "/admin/breeding/45",
    },
    {
        id: 3,
        userName: "Ahmad Fauzi",
        userImage: "/images/user/user-04.jpg",
        action: "menambahkan data pakan untuk",
        project: "Kandang C",
        type: "Pakan",
        time: "1 jam lalu",
        status: "online",
    ...
    },
    {
        ...
        action: "mengirim pengaduan tentang",
        project: "Kebersihan Kandang",
        type: "Pengaduan",
        time: "2 jam lalu",
        status: "online",
        route: "/admin/complaints/3",
    },
    {
        id: 5,
        userName: "Rudi Hartono",
        userImage: "/images/user/user-06.jpg",
        action: "melaporkan produksi susu dari",
        project: "Sapi Perah #D-012",
        type: "Produksi",
        time: "3 jam lalu",
        status: "offline",
    ...
    },
    {
        ...
        action: "menambahkan artikel tentang",
        project: "Perawatan Ternak",
        type: "Artikel",
        time: "5 jam lalu",
        status: "online",
        route: "/admin/articles/5",
    },
    {
        id: 7,
        userName: "Hendra Pratama",
        userImage: "/images/user/user-08.jpg",
        action: "melakukan pemeriksaan pada",
        project: "10 Ekor Sapi Fattening",
        type: "Kesehatan",
        time: "1 hari lalu",
        status: "online",
        route: "/admin/fattening",
    },
]);
...
const handleNotificationClick = (notification) => {
    // Navigasi ke halaman notifikasi menggunakan Inertia
...
const handleViewAllClick = (event) => {
    ...
    // Navigasi ke halaman semua notifikasi
